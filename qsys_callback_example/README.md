An example of how to create a Qsys component with elaboration callbacks. Note that any component that uses callbacks cannot be opened/edited by the Qsys component editor.
